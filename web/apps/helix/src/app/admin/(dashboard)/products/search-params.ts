...
// Keys mirror the products table's column ids and the `releases.products.list`
// tRPC input. Product lines are grouped by (type_key, name); `name`/`typeKey`
// are the filterable columns, sorted by `latestCreatedAt` by default.
