...
Rendering pulls no UI dependencies. The **editor** is a Tailwind v4 UI and
additionally wants `@helix-hq/design-system` installed — an optional peer, so
render-only consumers never see it.
