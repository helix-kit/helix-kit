...
import { DEFAULT_UPLOAD_ENDPOINT, uploadFile } from './upload';
...
const Editor = forwardRef<MDXEditorMethods, EditorProps>(
  ({ markdown, onChange, uploadEndpoint = DEFAULT_UPLOAD_ENDPOINT }, ref) => (
    <MDXEditor
      ref={ref}
      ...
      plugins={[
        ...
        linkDialogPlugin(),
        tablePlugin(),
        imagePlugin({ imageUploadHandler: (file) => uploadFile(file, uploadEndpoint) }),
