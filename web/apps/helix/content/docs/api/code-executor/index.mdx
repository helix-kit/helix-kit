---
title: '@helix-hq/code-executor'
description: 'Public API of @helix-hq/code-executor.'
---

The complete public surface of `@helix-hq/code-executor`, generated from the published type
